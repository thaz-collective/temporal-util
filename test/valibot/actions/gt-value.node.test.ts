...
describe('zonedDateTime', () => {
  ...
  test('untyped inputs', () => {
    ...
    expect(temporalGTValue(value)['~run']({ typed: false, value: null, issues }, {})).toStrictEqual({
      typed: false,
      value: null,
      issues,
    });
  ...
  describe('should return dataset with issues', () => {
    const baseIssue: Omit<TemporalGTValueIssue<Temporal.ZonedDateTime, typeof req>, 'input' | 'received'> = {
      kind: 'validation',
      type: 'temporal_gt_value',
      expected: `>${req.toJSON()}`,
      message: 'message',
...
describe('instant', () => {
  ...
  describe('should return dataset with issues', () => {
    const baseIssue: Omit<TemporalGTValueIssue<Temporal.Instant, typeof req>, 'input' | 'received'> = {
      kind: 'validation',
      type: 'temporal_gt_value',
      expected: `>${req.toJSON()}`,
      message: 'message',
...
describe('plainDateTime', () => {
  ...
  describe('should return dataset with issues', () => {
    const baseIssue: Omit<TemporalGTValueIssue<Temporal.PlainDateTime, typeof req>, 'input' | 'received'> = {
      kind: 'validation',
      type: 'temporal_gt_value',
      expected: `>${req.toJSON()}`,
      message: 'message',
...
describe('plainDate', () => {
  const requirement = Temporal.PlainDate.from('2024-06-01');
  const dateAction = temporalGTValue(requirement, 'message');
...
describe('plainTime', () => {
  ...
  describe('should return dataset with issues', () => {
    const baseIssue: Omit<TemporalGTValueIssue<Temporal.PlainTime, typeof req>, 'input' | 'received'> = {
      kind: 'validation',
      type: 'temporal_gt_value',
      expected: `>${req.toJSON()}`,
      message: 'message',
