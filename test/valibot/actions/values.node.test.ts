...
describe('zonedDateTime', () => {
  ...
  test('untyped inputs', () => {
    ...
    expect(temporalValues([value])['~run']({ typed: false, value: null, issues }, {})).toStrictEqual({
      typed: false,
      value: null,
      issues,
    });
  ...
  describe('should return dataset with issues', () => {
    const baseIssue: Omit<TemporalValuesIssue<Temporal.ZonedDateTime, typeof req>, 'input' | 'received'> = {
      kind: 'validation',
      type: 'temporal_values',
...
describe('instant', () => {
  ...
  describe('should return dataset with issues', () => {
    const baseIssue: Omit<TemporalValuesIssue<Temporal.Instant, typeof req>, 'input' | 'received'> = {
      kind: 'validation',
      type: 'temporal_values',
      expected: `=${req.map((r) => r.toJSON()).join(' | ')}`,
      message: 'message',
...
describe('plainDateTime', () => {
  ...
  describe('should return dataset with issues', () => {
    const baseIssue: Omit<TemporalValuesIssue<Temporal.PlainDateTime, typeof req>, 'input' | 'received'> = {
      kind: 'validation',
      type: 'temporal_values',
      expected: `=${req.map((r) => r.toJSON()).join(' | ')}`,
      message: 'message',
...
describe('plainDate', () => {
  ...
  const dateAction = temporalValues(requirement, 'message');
...
describe('plainTime', () => {
  ...
  describe('should return dataset with issues', () => {
    const baseIssue: Omit<TemporalValuesIssue<Temporal.PlainTime, typeof req>, 'input' | 'received'> = {
      kind: 'validation',
      type: 'temporal_values',
      expected: `=${req.map((r) => r.toJSON()).join(' | ')}`,
      message: 'message',
